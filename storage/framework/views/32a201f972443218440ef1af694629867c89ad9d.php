	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<a href="<?php echo e(route('clientes.desactivar')); ?>"><button type="button" class="btn btn-danger">Clientes Desactivados</button></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USUARIO\Desktop\electiva-4\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>