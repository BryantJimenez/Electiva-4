    ...
    <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
      <form action="<?php echo e(route('login')); ?>" method="POST" id="formLogin" class="login100-form validate-form">
        ...
        <div class="d-flex justify-content-center">
          <img src="<?php echo e(asset('/admins/img/logo.jpg')); ?>" width="95" height="70" alt="Logo">
        </div>
...
endif; ?>" type="email" name="email" required value="<?php echo e(old('email')); ?>" placeholder="Correo Electrónico" autofocus>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sistema-Cucar\resources\views/auth/login.blade.php ENDPATH**/ ?>