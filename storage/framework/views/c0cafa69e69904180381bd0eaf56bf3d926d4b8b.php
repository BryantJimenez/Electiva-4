  ...
  <div class="container-login100">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
      <form action="<?php echo e(route('login')); ?>" method="POST" id="formLogin" class="login100-form validate-form">
        ...
        <span class="login100-form-title p-b-33">LOS FRANCESES</span>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\losFranceses\resources\views/auth/login.blade.php ENDPATH**/ ?>