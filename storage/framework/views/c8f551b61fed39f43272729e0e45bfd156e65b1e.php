					...
					<table id="tabla" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td class="d-flex">
									<a class="btn btn-success btn-circle btn-sm" data-toggle="tooltip" data-placement="bottom" title="Imprimir Ticket" href="<?php echo e(route('ventas.ticket',encrypt($v->codigo))); ?>" target="_blank"><i class="fa fa-file-text-o"></i></a>&nbsp;&nbsp;

									<a class="btn btn-danger btn-circle btn-sm" data-toggle="tooltip" data-placement="bottom" title="Imprimir PDF" href="<?php echo e(route('ventas.factura',encrypt($v->codigo))); ?>" target="_blank"><i class="fa fa-file-pdf-o"></i></a>&nbsp;&nbsp;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\losFranceses\resources\views/admin/ventas/index.blade.php ENDPATH**/ ?>