					...
					<div class="row">
						...
						<div class="form-group col-lg-6 col-md-6 col-12">
							...
							<select class="form-control" name="type" required>
								<option value="">Seleccione</option>
								<option value="1" @if(old('type')==1) selected @endif>Administrador</option>
								<option value="2" @if(old('type')==2) selected @endif>Trabajador</option>
							</select>
						</div>
						...
						<div class="form-group col-12">
							...
							<textarea class="form-control" name="observation" placeholder="Introduzca su observación del usuario" minlength="2" maxlength="191">{{ old('observation') }}</textarea>
						</div>
						<div class="form-group col-12">
