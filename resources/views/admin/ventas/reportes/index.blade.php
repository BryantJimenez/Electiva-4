...
<link rel="stylesheet" type="text/css"href="{{ asset('/admins/css/daterangepicker.css') }}" />
...
<script type="text/javascript" src="{{ asset('/admins/js/highcharts/highcharts.js') }}"></script>
<script src="{{ asset('/admins/js/highcharts/series-label.js') }}"></script>
<script src="{{ asset('/admins/js/highcharts/exporting.js') }}"></script>
<script src="{{ asset('/admins/js/highcharts/export-data.js') }}"></script>
<script src="{{ asset('/admins/js/highcharts/accessibility.js') }}"></script>
<script type="text/javascript" src="{{ asset('/admins/js/daterangepicker.min.js') }}"></script>
...
<script type="text/javascript">
    ...
    function ajax(start, end) {
    	$('#reportrange span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        $.ajax({
        	url: '{{ route('reportes.ajax.rango') }}',
        	type: 'POST',
        	dataType: 'JSON',
        	data: {_token: '{{ csrf_token() }}', desde : start.format('YYYY-MM-DD'),hasta: end.format('YYYY-MM-DD')},
        })
        .done(function(data) {
